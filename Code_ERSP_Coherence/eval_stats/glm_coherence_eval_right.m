function glm_coherence_eval_right(S_OG,S_EKSO,channels,freq,muscle,phase,sel_ersp_data)
...
if sel_ersp_data ==0 %% left
    ERSP_OG=load('data_ERSP_right_left_gamma_OG.mat');
    ERSP_EKSO=load('data_ERSP_right_left_theta_EKSO.mat');
elseif sel_ersp_data==1 %% right
    ERSP_OG=load('data_ERSP_right_right_gamma_OG.mat');
    ERSP_EKSO=load('data_ERSP_right_right_theta_EKSO.mat');
end;
T_OG=load('OG_times_right.mat');
T_EKSO=load('ekso_times_right.mat');
[p_og,F_og,data_OG]=evaluate_coherence_OG_right(S_OG,channels,freq,phase,[100,100],muscle,[0.15 0.2],0,0);
[p_ekso,F_ekso,data_EKSO]=evaluate_coherence_right(S_EKSO,channels,freq,phase,[100,100],muscle,[0.15 0.2],0,0);
...
hval=fill(x2, inBetween,[23 23 23]./255);
...
%hold on;
scatter(TL_OG',data_val_L',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
%hold on;
scatter(TR_OG',data_val_R',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(T_T',data_val_T',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(TL_EKSO',data_val_L_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(TR_EKSO',data_val_R_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(T_T_EKSO',data_val_T_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(TL_S',data_val_L',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(TR_S',data_val_R',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
plot([0.1:0.01:1.5],ci,'r--');
%hold on;
scatter(TL_S_EKSO',data_val_L_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
scatter(TR_S_EKSO',data_val_R_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
%hold on;
scatter(data_val_L_ERSP'./12+0.2,data_val_L',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
%hold on;
scatter(data_val_L_ERSP_EKSO'./12+0.2,data_val_L_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
%hold on;
scatter(data_val_R_ERSP'./12+0.2,data_val_R',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
...
%hold on;
scatter(data_val_R_ERSP_EKSO'./12+0.2,data_val_R_EKSO',120,'bo','LineWidth',6)
legend off
set(findall(gca, 'Type', 'Line'),'LineWidth',6,'MarkerSize',17);
